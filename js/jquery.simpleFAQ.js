...
;(function($) {
  ...
  $.extend($.jk.SimpleFAQ.prototype, {
    ...
    slideSpeed: 100,           // Number or String The speed to open and close FAQ answers. String values must be one of the three predefined speeds: "slow", "normal", or "fast"; numeric values are the number of milliseconds to run the animation (e.g. 1000).
    ...
    keyTimeout: 300,           // Number Wait time before searching occurs
    partialTagScore: 0.0,      // Number What to increase the match score by when partial tags are matched (such as "sim" -> "simple")
    exactTagScore: 0.0,        // Number What to increase the match score by when an exact tag is matched (such as "simple" -> "simple")
